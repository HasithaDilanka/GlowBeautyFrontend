                ...
                <div className="flex flex-wrap justify-between gap-8">
                    ...
                    <div className="flex-1 min-w-[180px]">
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link to="/Reviews" className="text-blue-300 hover:text-white">Reviews</Link></li>
                            <li><Link to="/cart" className="text-blue-300 hover:text-white">Cart</Link></li>
                            <li><Link to="/contactUs" className="text-blue-300 hover:text-white">Contact Us</Link></li>
                    ...
                    <div className="flex-1 min-w-[220px]">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center">
                                ...
                                <span className="text-blue-200">123 Beauty Street, Colombo 03, Sri Lanka</span>
                            </div>
                            {/* Phone */}
                            <div className="flex items-center">
                                <svg className="w-5 h-5 text-blue-400 mr-3" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <span className="text-blue-200">+94 70 383 3096</span>
                            </div>
                            {/* Email */}
                            <div className="flex items-center">
                                <svg className="w-5 h-5 text-blue-400 mr-3" fill="currentColor" viewBox="0 0 24 24">
